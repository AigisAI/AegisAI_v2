...
- **Delivery Class**: [MVP Required | Optional Integration | Phase 2 Roadmap | Phase 3 Roadmap]
- **In Scope**: [List the user value this feature delivers now]
- **Explicitly Out of Scope**: [List related work that stays out of this feature]
- **Affected Surfaces**: [apps/api, apps/web, packages/shared, apps/ai(optional), docs, infra]
...
- [Document reasonable defaults you inferred from `spec 2.2.md` or repo context]
...
- **AC-001**: [State how this feature stays within MVP or, if not, how roadmap work is isolated]
- **AC-002**: [State how this feature respects the decoupled analysis architecture]
- **AC-003**: [State which shared contracts, security rules, or test obligations must remain intact]
