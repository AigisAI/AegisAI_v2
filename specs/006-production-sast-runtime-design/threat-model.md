...
| External lifecycle authority spoofing | Canary promotion, emergency suspension, or rollback occurs without the corresponding production decision | Exact per-edge authority type and digest-bound receipt; T048 accepts only its six-pass canary receipt; T049/T050 authorities remain unavailable | Missing/mismatched/cross-candidate receipt tests and default-unavailable suspension/rollback paths |
