...
1. Open the canonical execution entry point: [`specs/005-production-deployment-operations/quickstart.md`](./specs/005-production-deployment-operations/quickstart.md)
2. Follow the read order and execution flow defined there before touching code.
3. Use [`specs/005-production-deployment-operations/`](./specs/005-production-deployment-operations/) as the default implementation target unless a narrower active feature replaces it.

## Core References

- Canonical execution entry point: [`specs/005-production-deployment-operations/quickstart.md`](./specs/005-production-deployment-operations/quickstart.md)
...
- Active implementation package: [`specs/005-production-deployment-operations/`](./specs/005-production-deployment-operations/)
...
- Feature id: `005-production-deployment-operations`
...
5. `004-production-runtime-infrastructure` remains the completed runtime infrastructure baseline.
6. `003-production-ai-inference-runtime` remains the completed production AI inference baseline.
7. `002-production-scan-architecture` remains the completed production scan architecture baseline.
8. `spec 2.2.md` and `001-aegisai-mvp-foundation` remain legacy MVP references.
9. `.specify/memory/constitution.md` remains a repository guardrail reference.
...
- Stay inside the active production deployment operations milestone unless the current spec explicitly reclassifies deferred work.
...
- Re-run the final validation path from [`quickstart.md`](./specs/005-production-deployment-operations/quickstart.md) before claiming completion.
