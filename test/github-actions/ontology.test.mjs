...
test('active 006 spec explicitly reclassifies only the bounded issue 276 bootstrap', () => {
  ...
  assert.match(
    plan,
    /did not advance or satisfy T040[\s\S]{0,240}completed[\s\S]{0,120}T040 through T052[\s\S]{0,180}T053 repository-side provider handoff is package-ready[\s\S]{0,160}production-equivalent microVM execution/
  );
